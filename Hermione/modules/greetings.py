...
import Hermione.modules.sql.welcome_sql as sql
...
from Hermione.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from Hermione.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Hermione.modules.helper_funcs.msg_types import get_welcome_type
from Hermione.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Hermione.modules.log_channel import loggable
from Hermione.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh hi, my master join this group 🥳 party🥳 party🥳 party🥳", reply_to_message_id=reply
                )
                welcome_log = (
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll go around and not welcome anyone then."
            )
