...
from Hermione.function.pluginhelpers import admins_only, get_text
from Hermione.services.pyrogram import pbot

@pbot.on_message(filters.command("cedit") & ~filters.edited & ~filters.bot)
@admins_only
...
HELPSTRINGS = "reply to any message to edit caption✍"

__help__ = HELPSTRINGS
__funtools__ = HELPSTRINGS
__mod_name__ = "Caption Editer✍" 
