...
import Hermione.modules.sql.global_bans_sql as gban_sql
import Hermione.modules.sql.users_sql as user_sql
from Hermione import DEV_USERS, OWNER_ID, dispatcher
