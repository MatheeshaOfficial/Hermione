...
import Hermione.modules.sql.connection_sql as sql
from Hermione import dispatcher, DRAGONS, DEV_USERS
from Hermione.modules.helper_funcs import chat_status
