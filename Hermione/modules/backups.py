...
import Hermione.modules.sql.notes_sql as sql
from Hermione import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Hermione.__main__ import DATA_IMPORT
from Hermione.modules.helper_funcs.chat_status import user_admin
from Hermione.modules.helper_funcs.alternate import typing_action

# from Hermione.modules.rules import get_rules
import Hermione.modules.sql.rules_sql as rulessql

# from Hermione.modules.sql import warns_sql as warnssql
import Hermione.modules.sql.blacklist_sql as blacklistsql
from Hermione.modules.sql import disable_sql as disabledsql

# from Hermione.modules.sql import cust_filters_sql as filtersql
# import Hermione.modules.sql.welcome_sql as welcsql
import Hermione.modules.sql.locks_sql as locksql
from Hermione.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("HermioneSlBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("HermioneSlbot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Hermione-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("HermioneSlbot{}.backup".format(chat_id))  # Cleaning file
