# Copyright (C) 2021 HermioneSlBot
# made by @HermioneSlBot on Telegram. 
# github account : https://github.com/PercyOfficial
# This file is part of HermioneSlBot (Telegram Bot)
...
from Hermione import telethn
from Hermione.services.telethonuserbot import ubot
...
__help__ = """
  • /checkwho*:* Get A Name History Of User
  (C) @HermioneSlBot| @Rodolphus_Lestrang
"""

__mod_name__ = "NameHistory🤫"
