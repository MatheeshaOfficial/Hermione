...
from Hermione.events import register as Hermione
...
async def _(event):
    ...
    async with ubot.conversation(chat) as conv:
        ...
        try:
            ...
            await event.reply("```Please unblock @HermioneSlBot and try again```")
...
HELPSTRINGS = """
*Available Commands*:
- /sg [REPLY]: Get the Username and Name history of user
"""

__help__ = HELPSTRINGS 
__funtools__ = HELPSTRINGS 
__mod_name__ = "ɴᴀᴍᴇ-ʜɪꜱᴛᴏʀʏ"
