...
from Hermione.function.pluginhelpers import edit_or_reply, get_text
...
@hermione.on_message(filters.command("collage") & ~filters.edited & ~filters.bot)
...
HELPSTRINGS = """Create Collage From All Images in A Chat.
• /collage (input or current chat will be taken) 
"""
__mod_name__ = "Collage🖼️"
