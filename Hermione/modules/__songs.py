...
from Hermione.pyrogramee.dark import get_arg


@Hermione.on_message(filters.command("saavn"))
...
import aiohttp
from pyrogram import filters
from Hermione import pbot as Hexzy
...
@Hermione.on_message(filters.command("deezer"))
...
import aiohttp
from pyrogram import filters
from Hermione import pbot as CHABEE
